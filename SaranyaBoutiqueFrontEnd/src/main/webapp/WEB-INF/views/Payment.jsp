 ...
 <form:form role="form" method="post" modelAttribute="pay"> 
   <div class="form-group"> 
 					  <label>Card Type</label> 
 						...
 						<form:option value="Visa-Debit/Credit" label="Visa-Debit/Credit" />     					<form:option value="Mastercard" label="Mastercard" /> 
 					  ...
 					  <label >Expiry Date</label> 
 						...
 						<div class="col-sm-6"> 
 						 ...
 						 <form:select path="expiryMonth" class="form-control" > 
     						...
     						<form:option value="02" label="02" /> 2     						<form:option value="03" label="03" /> 
