...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %> 
 ...
 <tr> 
 <th ng-click="sort('pid')"> <a style="color: blue;" href="#"> <span class="glyphicon glyphicon-chevron-down"> Product Id</span> </a> </th> 
<th ng-click="sort('image')"> <a style="color: blue;" href="#">  <span class="glyphicon glyphicon-chevron-down">  Product</span></a>  </th> 
 <th ng-click="sort('name')"> <a style="color: blue;" href="#"> <span class="glyphicon glyphicon-chevron-down">  Dress  name</span></a>  </th> 
 <th ng-click="sort('price')"> <a style="color:blue;" href="#"> <span class="glyphicon glyphicon-chevron-down"> price</span></a>  </th> 
 <th></th> 
 </tr> 
 	<c:if test="${pid==1}" > 
 	<tr ng-repeat="product in data|filter:{category:'Party wear'}|filter:query|orderBy:sortKey:reverse" > 
 	</c:if> 
